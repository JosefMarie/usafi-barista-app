                            ...
                            <div className="p-5 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 relative z-10">
                                <div className="flex items-center gap-4 md:gap-5 p-4 md:p-5 bg-white/40 dark:bg-white/5 rounded-xl md:rounded-2xl border border-white/20 shadow-sm transition-transform hover:scale-[1.02]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-green-700 dark:text-green-400 text-sm font-black">ACTIVE & PAID</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4 md:gap-5 p-4 md:p-5 bg-white/40 dark:bg-white/5 rounded-xl md:rounded-2xl border border-white/20 shadow-sm transition-transform hover:scale-[1.02]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-espresso/70 dark:text-white/70 text-sm font-black uppercase">GOLD SEEKER</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-4 md:gap-5 text-left">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-espresso/50 dark:text-white/50 text-xs font-medium">Manage your visibility and data</p>
                                        </div>
                                    </div>
                                    <span className="material-symbols-outlined text-espresso/30 group-hover/item:translate-x-2 transition-transform">arrow_forward</span>
                                </button>
