...
export function StudentOpportunities() {
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-[#F5DEB3] dark:bg-[#1c1916] overflow-y-auto w-full">
            <div className="w-full space-y-10">
                {/* Header Section */}
                <div className="flex items-center justify-between relative mb-12">
                    <div className="absolute left-0 top-0 bottom-0 w-2 bg-espresso/20 -ml-2 rounded-full"></div>
                    <div>
                        <h1 className="text-4xl font-serif font-black text-espresso dark:text-white uppercase tracking-tight leading-none">
                            Career Opportunities
                        </h1>
                        <p className="text-[10px] font-black text-espresso/40 dark:text-white/40 uppercase tracking-[0.3em] mt-2">
                    ...
                    {jobs.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-32 gap-6 bg-white/20 rounded-[3rem] border-2 border-dashed border-espresso/10 opacity-60">
                            ...
                            <div className="text-center">
                                <h3 className="text-[10px] font-black uppercase tracking-[0.5em] text-espresso">No Openings Available</h3>
                                <p className="text-[8px] font-black uppercase tracking-[0.3em] mt-2 text-espresso/50">Check back later for new opportunities</p>
                            </div>
                        </div>
                    ) : (
                        jobs.map(job => (
                                ...
                                <div className="flex-1 space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <p className="text-[10px] font-black text-espresso/40 uppercase tracking-[0.3em] mt-1">
                                        ...
                                        <div className="bg-white/60 dark:bg-black/40 p-6 rounded-[2rem] border border-espresso/5 shadow-inner relative overflow-hidden">
                                            ...
                                            <div className="relative z-10">
                                                <p className="text-[8px] font-black text-espresso/30 uppercase tracking-[0.4em] mb-3">Job Description & Requirements</p>
                                ...
                                <div className="md:w-[280px] shrink-0 flex flex-col justify-between space-y-6 md:pt-2 md:pl-8 md:border-l border-espresso/10">
                                    <div className="space-y-3">
                                        <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/30 dark:bg-white/5 border border-espresso/5">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-espresso dark:text-white">{job.salaryRange || 'Not Disclosed'}</p>
                                            </div>
                                        </div>
                                        ...
                                        {(job.contactPhone || job.contactEmail) && !job.applicationLink && (
                                            <div className="p-4 rounded-3xl bg-espresso/5 border border-espresso/5 space-y-3">
                                                <p className="text-[8px] font-black text-espresso/40 uppercase tracking-widest text-center">Contact Directly</p>
                                    ...
                                    {job.applicationLink ? (
                                        ...
                                        >
                                            ...
                                            <span className="font-serif font-black text-lg tracking-wide uppercase z-10">Apply Now</span>
                                            <span className="material-symbols-outlined z-10 group-hover/btn:translate-x-1 transition-transform">arrow_forward</span>
                                        </a>
                                    ) : (
