...
export function AdminLayout() {
    ...
    const navItems = [
        ...
        { icon: 'analytics', label: 'Business Insights', path: '/admin/business/analytics' },
        { icon: 'calendar_month', label: 'Weekend Exp', path: '/admin/weekend' },
        { icon: 'person', label: t('admin.nav.my_profile'), path: '/admin/profile' },
    ];

    return (
        <div className="h-screen w-full bg-[#F5DEB3] dark:bg-[#1c1916] flex flex-col overflow-hidden">
            <GlobalAnnouncement />
